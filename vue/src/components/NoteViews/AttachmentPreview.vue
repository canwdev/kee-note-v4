...
import {getAttachment} from '@/api/keepass'
...
<template>
  <n-modal
    ...
    :title="`Preview Attachment (${mIndex + 1}/${attachmentNames?.length})`"
    preset="card"
    size="small"
  ...
  >
    <div class="attachment-preview">
      <n-space align="center" justify="center">
        <n-button-group>
          <n-button @click="goPrev">Prev</n-button>
          <n-button @click="goNext">Next</n-button>
        </n-button-group>
        <n-button @click="handleDownload">Download</n-button>
      </n-space>
      ...
      <div class="filename-title" :title="fileMimeType">{{ filename }}</div>
    </div>
  </n-modal>
</template>
